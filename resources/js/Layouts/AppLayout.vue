        ...
        <div class="flex bg-gray-50 min-h-screen">
            ...
            <div :class="state.isSidebarOpen ? 'w-64' : 'w-20'"
                ...
                <div class="flex flex-col h-full">
                    ...
                    <!-- Logout Button -->
                    <div class="mt-auto">
                        <a href="#" class="flex items-center p-2 rounded-md hover:bg-gray-700 transition duration-200">
                            <svg v-show="state.isSidebarOpen" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                class="h-6 w-6 mr-2">
                                <path

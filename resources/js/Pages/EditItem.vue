...
const form = useForm({
    ...
    item_condition: props.item.item_condition,
...
const submit = () => {
    form.post(route('items.update', { item: props.item.id }));
};

</script>

<template>
    <AppLayout title="Update Item">
        <div class="w-full h-auto mt-8">
            <p class="bg-gray-400 px-2 rounded-md py-2 text-lg font-bold">Update Items</p>
                ...
                <div class="flex flex-row justify-between mt-4 gap-4">
                    <div class="w-1/2 flex flex-col px-2">
                        ...
                        <div class="mb-5">
                            ...
                            <TextInput id="price" v-model="form.price" type="number" class="mt-2 block w-full"
                        ...
                        <div class="mb-5">
                            ...
                            <Checkbox id="status" v-model="form.status"
